...
$featuredProducts = "select products.*, categories.name as 
catname from products left join categories on products.category_id = categories.id
 where featured = 1 order by id desc limit 3 ";
        ...
        <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('<?php echo $productImage ?>');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3" style="text-align: center;background-color: rgba(0, 0, 0, 0.5); padding: 5px; border-radius: 5px;">
                <svg class="bi me-2" width="1em" height="1em"><use xlink:href="#geo-fill"></use></svg>
                <small><?php echo $row['catname']; ?></small>
              </li>
